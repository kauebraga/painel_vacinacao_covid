...
header <- dashboardHeader(
  ...
  tags$li(class="dropdown", tags$a(href="https://data.brasil.io/dataset/covid19/microdados_vacinacao.csv.gz", sprintf("Última atualização: %s", "15/03/2021"), target="_blank")),
